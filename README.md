...
默认每天北京时间 09:00 和 21:00 更新一次。GitHub Actions cron 使用 UTC 时间，
对应 `.github/workflows/brief.yml` 中的 `0 1,13 * * *`。
...
**Q: 需要费用吗？**
A: GitHub Actions 公开仓库免费。LLM API 根据用量收费，250 博主每天 2 次约 $1-2/月。
